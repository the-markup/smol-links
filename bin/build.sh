...
echo
docker-compose exec web /var/www/html/wp-content/plugins/smol-links/bin/drop-database.sh
docker-compose exec web /var/www/html/wp-content/plugins/smol-links/bin/install-wp-tests.sh wordpress wordpress wordpress db
echo
